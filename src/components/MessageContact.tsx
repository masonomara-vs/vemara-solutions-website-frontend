...
import { sendEmail } from '../../utils/send-message-email';
    ...
    <div className={styles.wrapper}>
      <div className={styles.container}>
        ...
        >
          ...
          <div className={styles.inputWrapper}>
            <label htmlFor='message' className="inactive">
              Any thoughts or questions you would like to share? <span className="dull">(Required)</span>
            </label>
            <textarea
              id='message'
              rows={5}
              placeholder='Share any thoughts or questions, including technical, practical, and other specifics'
        ...
        <motion.div className={styles.media} variants={fadeIn("up", "spring", 0, 0.8)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0 }}>
          <Image src="/chess.gif" alt="Vemara Solutions" unoptimized fill style={{ objectFit: "cover" }} />
        </motion.div>
      </div>
    </div>
  );
